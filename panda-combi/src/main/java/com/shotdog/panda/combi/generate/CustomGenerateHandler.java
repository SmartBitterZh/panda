...
public class CustomGenerateHandler {
    ...
    private void tableHandler(Table table) {
        ...
        String fieldType = CommonUtils.toJavaType(pkColumnType, 0, 0);
    ...
    private void fieldHandler(String tableName, Field field) {
        ...
        String fieldType = CommonUtils.toJavaType(CommonUtils.toUpper(columnType), field.getSize(), field.getDigits());
